...
class SkillClassifier:
    ...
    STATISTICAL_KEYWORDS = {
        "test", "hypothesis", "regression", "correlation", "analysis",
        "distribution", "probability", "confidence", "significance",
        "variance", "standard deviation", "mean", "median", "mode",
        "p-value", "anova", "chi-square", "t-test", "z-test",
        "bayes", "bayesian", "monte carlo", "bootstrap", "sampling",
        "estimate", "estimation", "fit", "fitting", "model", "modeling",
        "predict", "prediction", "forecast", "forecasting", "trend",
        "outlier", "anomaly", "cluster", "clustering", "classify",
        "classification", "dimensionality", "pca", "factor", "latent",
    }
    
    # Keywords indicating mathematical implementations
    MATH_KEYWORDS = {
        "algorithm", "sort", "search", "graph", "tree", "heap", "stack",
        "queue", "hash", "dynamic programming", "recursion", "iteration",
        "matrix", "vector", "transform", "rotation", "geometry", "calculus",
        "integration", "differentiation", "derivative", "equation", "solve",
        "root", "polynomial", "factorial", "fibonacci", "prime", "combinatorial",
        "permutation", "sequence", "series", "limit", "convergence", "fractal",
        "bezier", "spline", "interpolation", "optimization", "minimize",
        "maximize", "coordinate", "affine", "projection", "reflection",
    }
    
    # Keywords indicating data types
    DATA_TYPE_KEYWORDS = {
        DataType.NUMERICAL: {
            "number", "numeric", "integer", "float", "decimal", "continuous",
            "discrete", "count", "value", "magnitude", "measurement",
        },
        DataType.CATEGORICAL: {
            "category", "class", "label", "group", "factor", "nominal",
            "ordinal", "binary", "boolean", "yes/no", "true/false",
        },
        DataType.TIME_SERIES: {
            "time", "date", "temporal", "sequence", "trend", "seasonal",
            "forecast", "historical", "period", "interval", "timestamp",
        },
        DataType.TEXT: {
            "text", "string", "word", "sentence", "document", "corpus",
            "natural language", "token", "vocabulary", "semantic",
        },
    }
