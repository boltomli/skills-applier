...
from ..recommendation.alternatives import Alternative, AlternativeSet
...
"""
        ...
        self.console.print(Panel(panel_content, title="Recommendation Details", border_style="cyan"))
...
"""
    ...
    def show_progress(self, current: int, total: int, message: str):
        ...
        self.console.print(f"\r[cyan]{message}[/cyan] [{bar}] {current}/{total} ({percent:.1f}%)", end="")
        self.console.print()
