...
class ProblemClassifier:
    ...
    TYPE_KEYWORDS = {
        ProblemType.HYPOTHESIS_TEST: [
            "test", "hypothesis", "significant", "p-value", "reject", "null",
        ],
        ProblemType.ONE_SAMPLE_TEST: [
            "one sample", "compare to", "known value", "population mean",
        ],
        ProblemType.TWO_SAMPLE_TEST: [
            "two sample", "compare two", "difference between", "groups",
        ],
        ProblemType.ANOVA: [
            "anova", "analysis of variance", "multiple groups", "more than two",
        ],
        ProblemType.CHI_SQUARE: [
            "chi-square", "chi square", "independence", "contingency",
        ],
        ProblemType.REGRESSION: [
            "regression", "predict", "model", "relationship",
        ],
        ProblemType.LINEAR_REGRESSION: [
            "linear regression", "fit line", "slope", "intercept",
        ],
        ProblemType.LOGISTIC_REGRESSION: [
            "logistic regression", "binary outcome", "probability",
        ],
        ProblemType.CORRELATION: [
            "correlation", "relationship", "association", "related",
        ],
        ProblemType.CLASSIFICATION: [
            "classify", "predict class", "category prediction", "label",
        ],
        ProblemType.CLUSTERING: [
            "cluster", "group", "segment", "unsupervised",
        ],
        ProblemType.DESCRIPTIVE: [
            "describe", "summarize", "statistics", "mean", "median", "mode",
        ],
        ProblemType.DISTRIBUTION_ANALYSIS: [
            "distribution", "normality", "histogram", "shape",
        ],
        ProblemType.OPTIMIZATION: [
            "optimize", "optimal", "best", "minimize", "maximize",
        ],
        ProblemType.MINIMIZATION: [
            "minimize", "minimum", "reduce", "lowest",
        ],
        ProblemType.MAXIMIZATION: [
            "maximize", "maximum", "increase", "highest",
        ],
        ProblemType.SIMULATION: [
            "simulate", "simulation", "generate", "random",
        ],
        ProblemType.MONTE_CARLO: [
            "monte carlo", "random sampling", "estimate", "probability",
        ],
        ProblemType.BOOTSTRAP: [
            "bootstrap", "resample", "confidence interval",
        ],
        ProblemType.TIME_SERIES: [
            "time series", "over time", "temporal", "sequence",
        ],
        ProblemType.FORECASTING: [
            "forecast", "predict future", "projection", "trend",
        ],
    }
...
- complexity_level: Complexity level (simple, moderate, complex)"""
    ...
    def _assess_complexity(self, text: str, num_subtypes: int) -> str:
        ...
        complexity_indicators = [
            ...
            "multivariate", "interaction", "nested",
        ]
